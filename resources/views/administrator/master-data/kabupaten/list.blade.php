...
<div class="page-header-right ms-auto">
    <div class="page-header-right-items">
        <div class="d-flex align-items-center gap-2 page-header-right-items-wrapper">
            <a href="javascript:void(0)" id="addData" class="btn btn-primary successAlertMessage">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="formModalLabel">Form Kabupaten</h1>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group mb-3">
                                <label for="">Kode Kabupaten<sup>
                                        <font color="red">*</font>
                                    </sup></label>
                                <input type="text" class="form-control" name="kode_kabupaten" id="inputKodeKabupaten" required />
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control" name="nama_kabupaten" id="inputNamaKabupaten" required />
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    async function getListData(limit = 10, page = 1, ascending = 0, search = '') {
        ...
        const getDataRest = await CallAPI(
            'GET',
            `{{ route('api.administrator.master.kabupaten.list') }}`, {
                page: page,
                limit: limit,
                ascending: ascending,
                search: search
        ...
        if (getDataRest.status == 200) {
            ...
            for (let index = 0; index < data.length; index++) {
                ...
                <tr>
                    <td>${index_loop}</td>
                    <td><b>${element.kode_administratif}</b></td>
                    <td>${element.nama}</td>
                    <td>
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end" data-id="${element.id}">
                            <button class="btn btn-warning btn-sm me-md-2 edit-data" type="button">
                                <i class="fa-solid fa-eye"></i> Ubah
                            </button>
                            <button class="btn btn-danger btn-sm delete-data" type="button">
