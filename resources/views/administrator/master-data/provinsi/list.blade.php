        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="formModalLabel">Form Provinsi</h1>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group mb-3">
                                <label for="">Kode Provinsi<sup>
                                        <font color="red">*</font>
                                    </sup></label>
                                <input type="text" class="form-control" name="kode_provinsi" id="inputKodeProvinsi" required />
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control" name="nama_provinsi" id="inputNamaProvinsi" required />
                            </div>
                        </div>
                    </div>
