        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="formModalLabel">Form</h1>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group mb-3">
                                ...
                                <textarea class="form-control" name="keterangan" id="inputKeterangan"></textarea>
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    async function getListData(limit = 10, page = 1, ascending = 0, search = '') {
        ...
        const getDataRest = await CallAPI(
            'GET',
            `{{ route('api.administrator.master.jenis-angkutan.list') }}`, {
                page: page,
                limit: limit,
                ascending: ascending,
                search: search
